			...
			if ($entry != "." && $entry != ".."){
				if($entry == "index.php" or $entry == "elimina.php"){
					...
					echo "<table>
								...
								<tr>
									<td>$entry</td>
									<td><a style='text-decoration:none;' href='../video/$entry'><font style='color:red;'>$entry</font></a></td>
									<td><a style='text-decoration:none;' href='../video/$entry' download>Download - $entry</a></td>
								</tr>
								</table>";
				}
			}
